...
//class Seter extends \Seter\Base\Base implements \ArrayAccess, \Countable, \IteratorAggregate
class BaseSeter  implements \ArrayAccess, \Countable, \IteratorAggregate
{
    //this下就是seter下 seter下就是下面对象的
    //例如$this->db
    /*
     * $this->db
     * $this->isguest
